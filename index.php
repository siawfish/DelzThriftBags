...
<head>
    ...
    <!-- Title  -->
    <title>Delz Thriftbags | Home</title>
...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="products-catagories-area clearfix">
            ...
            <?php
            $sql = "SELECT * FROM items WHERE avail='0' GROUP BY itemNo";
            $query = mysqli_query($db_conx, $sql);
            if(!$query){
                echo "<div style='color:red; text-align:center; font-size:15px; padding:50px;'>We are experiencing some tech issues. Check back later</div>";
            }
            $itemsCount = mysqli_num_rows($query);
            if($itemsCount<1){
                echo "<div style='color:pink; text-align:center; font-size:15px; padding:50px;'>No bags are available at the moment. Please check back later</div>";
            }
