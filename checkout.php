...
<head>
    ...
    <!-- Title  -->
    <title>Delz Thriftbags | Checkout</title>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="mobile-nav">
            ...
            <div class="amado-navbar-brand">
                <a style="font-size: large;" href="index.php"><img src="img/core-img/bag.png" width="15px" height="15px"/>Delz Thriftbags</a>
            </div>
            <!-- Navbar Toggler -->
        ...
        <header class="header-area clearfix">
            ...
            <!-- Logo -->
            <div class="logo">
                <a href="index.php"><img width="40px" height="40px" style="margin-left: 5px; margin-right: 5px;" src="img/core-img/bag.png"/>Delz Thriftbags</a>
            </div>
            <!-- Amado Nav -->
            <nav class="amado-nav">
                <ul>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single_widget_area">
                        ...
                        <div class="logo mr-50">
                            <a href="index.php" style="font-size: 30px; padding-bottom: 0px; color:pink;"><img width="30px" height="30px" style="margin-left: 5px; margin-right: 5px;" src="img/core-img/bag.png"/>Delz Thriftbags</a>
                        </div>
                        <!-- Copywrite Text -->
